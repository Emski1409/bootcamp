    ...
    $num = rand(1,4);
		...
		<style id="user-style-Hicksdesign-bg-img">
  		body.user-style-Hicksdesign {
				background-image: url(twitbay_files/background1.jpg);
        }
		</style>
    					...
    					<div class="profile-header">
    							<div class="profile-info clearfix">
        							...
        							<div class="profile-details">
      						        ...
      						        <div class="url">
                                        <a target="_blank" rel="me nofollow" href="https://calibrae.com">https://calibrae.com</a>
      						        </div>
                                </div>
  						</div>
